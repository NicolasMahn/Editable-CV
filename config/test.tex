...
% Every tag may only be 20 characters long.
% Cursor, PyCharm, VS Code, Jupyter Notebook, AWS, Docker, Git, GitHub, Linux, Bash, UML, MS Office, Atlassian Suite, Confluence, Jira, LaTeX, Overleaf, Markdown, WordPress, Postman, MySQL, PostgreSQL, MongoDB Compass, Power BI, Slack, Teams, Zoom, SSH, MS Office, Terminal, Hugging Face, Ollama, OpenAI API, ChromaDB, Pinecone, n8n
