\setCVOptions{
    ...
    programming={Python, Java, REST, GraphQL, SQL, Docker, Bash, CI/CD, Git, API Design, System Design, Cloud Deployment, PyTorch},
    management={Agile Mindset, Scrum, KANBAN, \\, Change Management, Cross-Function Teams},
    tools={Cursor, PyCharm, VS Code, \\, Jupyter Notebook, AWS, Atlassian Suite},
